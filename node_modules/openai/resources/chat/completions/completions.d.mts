...
import * as ChatCompletionsAPI from "./completions.mjs";
...
import { ChatCompletionToolRunnerParamsWithContext, ChatCompletionToolRunnerParamsWithoutContext } from "../../../lib/ChatCompletionRunner.mjs";
import { ChatCompletionStreamingToolRunnerParamsWithContext, ChatCompletionStreamingToolRunnerParamsWithoutContext } from "../../../lib/ChatCompletionStreamingRunner.mjs";
import { type RunnableToolFunctionWithContext } from "../../../lib/RunnableFunction.mjs";
...
export declare class Completions extends APIResource {
     ...
     */
    runTools<ToolContext, Params extends Omit<ChatCompletionToolRunnerParamsWithContext<any, ToolContext>, 'toolContext' | 'tools'> = Omit<ChatCompletionToolRunnerParamsWithContext<any, ToolContext>, 'toolContext' | 'tools'>, ParsedT = ExtractParsedContentFromParams<Params & ChatCompletionToolRunnerParamsWithContext<any, ToolContext>>>(body: Params & {
        toolContext: ToolContext;
        tools: readonly RunnableToolFunctionWithContext<ToolContext>[];
    }, options?: RunnerOptions): ChatCompletionRunner<ParsedT>;
    runTools<ToolContext, Params extends Omit<ChatCompletionStreamingToolRunnerParamsWithContext<any, ToolContext>, 'toolContext' | 'tools'> = Omit<ChatCompletionStreamingToolRunnerParamsWithContext<any, ToolContext>, 'toolContext' | 'tools'>, ParsedT = ExtractParsedContentFromParams<Params & ChatCompletionStreamingToolRunnerParamsWithContext<any, ToolContext>>>(body: Params & {
        toolContext: ToolContext;
        tools: readonly RunnableToolFunctionWithContext<ToolContext>[];
    }, options?: RunnerOptions): ChatCompletionStreamingRunner<ParsedT>;
    runTools<Params extends ChatCompletionToolRunnerParamsWithoutContext<any>, ParsedT = ExtractParsedContentFromParams<Params>>(body: Params, options?: RunnerOptions): ChatCompletionRunner<ParsedT>;
    runTools<Params extends ChatCompletionStreamingToolRunnerParamsWithoutContext<any>, ParsedT = ExtractParsedContentFromParams<Params>>(body: Params, options?: RunnerOptions): ChatCompletionStreamingRunner<ParsedT>;
    /**
...
export { type ChatCompletionToolRunnerParams, type ChatCompletionToolRunnerParamsWithContext, type ChatCompletionToolRunnerParamsWithoutContext, } from "../../../lib/ChatCompletionRunner.mjs";
export { type ChatCompletionStreamingToolRunnerParams, type ChatCompletionStreamingToolRunnerParamsWithContext, type ChatCompletionStreamingToolRunnerParamsWithoutContext, } from "../../../lib/ChatCompletionStreamingRunner.mjs";
