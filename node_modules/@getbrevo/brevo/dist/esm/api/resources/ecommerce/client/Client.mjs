...
export class EcommerceClient {
    ...
    __getAttributionMetricsForOneOrMoreBrevoCampaignsOrWorkflows() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/ecommerce/attribution/metrics");
        });
    }
    /**
    ...
    __getDetailedAttributionMetricsForASingleBrevoCampaignOrWorkflow(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/ecommerce/attribution/metrics/{conversionSource}/{conversionSourceId}");
        });
    }
    /**
    ...
    __getAttributedProductSalesForASingleBrevoCampaignOrWorkflow(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/ecommerce/attribution/products/{conversionSource}/{conversionSourceId}");
        });
    }
    /**
    ...
    __getTheIso4217CompliantDisplayCurrencyCodeForYourBrevoAccount(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/ecommerce/config/displayCurrency");
        });
    }
    /**
    ...
    __setConfigDisplayCurrency(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/ecommerce/config/displayCurrency");
        });
    }
    /**
     * Get all the orders
